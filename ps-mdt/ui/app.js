...
function timeAgo(dateParam) {
  ...
  if (seconds < 5) {
    ...
    return `${seconds} För några sekunder sedan`;
  } else if (seconds < 90) {
    return "För ungefär en minut sedan";
  } else if (minutes < 60) {
...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`Du håller på att redigera ${result["firstname"]} ${result["lastname"]}`);
    ...
    let convHTML = '<div style="color: #fff; text-align:center;">Rent bakgrund</div>';
    let incidentsHTML = '<div style="color: #fff; text-align:center;">Inga incidenter</div>';
    let vehHTML = '<div style="color: #fff; text-align:center;">Inga fordon</div>';
    let galleryHTML = '<div style="color: #fff; text-align:center;">Inga bilder</div>';
    let propertyHTML = '<div style="color: #fff; text-align:center;">Inga bostäder</div>';
    ...
    if (canCreateBulletin == 0) {
      ...
      $(".bulletin-items-continer")
        .prepend(`<div class="bulletin-item" data-id="${canCreateBulletin}">
                ...
                <div class="bulletin-date">${MyName} - Precis nu</div>
                </div>
            </div>`);
    } else {
            ...
            .each(function (index) {
              if ($(this).data("id") == cid) {
                if ($(this).hasClass("green-tag")) {
                  if ($(this).text() == "Skyldig") {
                    guilty = true;
                  }
                  if ($(this).text() == "Efterlysning") {
                    warrant = true;
                  }
                  if ($(this).text() == "Bearbetas") {
                    processed = true;
                  }
                  if ($(this).text() == "Associerad") {
                    isassociated = true;
                  }
                }
              }
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      ...
      <div style="color: white;">
          ...
          <p><em>[Infoga rapportsammanfattning här]</em></p>
          <p>&nbsp;</p>
          <p><strong>🧍 Gisslan:</strong> [Namn här]</p>
          <p>&nbsp;</p>
          <p><strong>🗄️ Bevis Location:</strong> Förråd # | Låda #</p>
          <p>&nbsp;</p>
          <p><strong>🔪 Vapen/Matrial Konfiskerad:</strong></p>
          <p><em>· [Infoga lista här]</em></p>
          <p>&nbsp;</p>
          <p>-----</p>
          <p><strong style="background-color: var(--color-1);">💸 Bötfäll:</strong></p>
          <p>&nbsp;</p>
          <p><strong>⌚ Döma:</strong></p>
          <p>-----</p>
      </div>
  `;
    ...
    $(".manage-incidents-reports-content").trumbowyg('html', template);
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Hantera incidenten</div>
  ...
  $(".manage-bolos-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        template = `
        <div style="color: white;">
            <p><strong>📝  AKUT Rum #: [ # ]</strong></p>
            <p><strong>Rapport ID: [ Rapportera ID ]</strong></p>
            <p><em><br></em></p>
            <p><strong>🧍Tid antagen: [ Datum och tid här ]</strong>&nbsp;</p>
            <p><strong>Kirurgi: [Ja/Nej]</strong></p>
            <p><strong>Skador/åkommor:</strong></p>
            <p><em>· [Ange listan över skador här]</em><br></p>
            <p>&nbsp;</p>
            <p>-----</p>
            <p><strong style="background-color: var(--color-1);">Ytterligare närvaro:</strong><br></p>
            <p><em>· [ Lista eventuell annan personal här ]</em></p>
            <p><strong style="background-color: var(--color-1);">🧑‍🤝‍🧑 Ytterligare nödkontakter:</strong><br></p>
            <p><em>· [ Namn Och Nummer ]</em></p>
            <p><strong style="background-color: var(--color-1);">Anteckningar:</strong><br></p>
            <p><em>· [Ytterligare anmärkningar här]</em></p>
            <p>-----</p>
        </div>
    `;
      }
      $(".manage-bolos-editing-title").html(
        "Du sätter en efterlysning"
      );
          ...
          `
            <div class="associated-incidents-user-container" data-id="${$(this).data("cid")}">
                ...
                <div class="associated-incidents-user-tags-holder">
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Efterlysning</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Skyldig</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Bearbetas</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Associerad</div>
                </div>
                <div class="modify-charges-label"><span class="fas fa-solid fa-info"></span> Högerklicka nedan för att lägga till och/eller ändra avgifter.</div>
                <div class="associated-incidents-user-holder" data-name="${$(this).data("cid")}"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Rekommenderas Böter</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Rekommenderas Fängelsetid</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Bötfäll</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Fängelsetid</div>
                ...
                <div class="associated-incidents-controls" data-id="${$(this).data("cid")}">
                    <div id="jail-button" class="control-button" data-id="${$(this).data("cid")}"><span class="fa-solid fa-building-columns" style="margin-top: 3.5px;"></span> Fängelse</div>
                    <div id="fine-button" class="control-button" data-id="${$(this).data("cid")}"><span class="fa-solid fa-file-invoice-dollar" style="margin-top: 3.5px;"></span> Bötfäll</div>
                    ${canSendToCommunityService ? `<div id="community-service-button" class="control-button" data-id="${$(this).data("cid")}"> <span class="fa-solid fa-person-digging" style="margin-top: 3.5px;"></span>Samhällstjänst</div>` : ''}
                </div>
            </div>
          `
        );
  ...
  $(".manage-reports-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        template = `
    <div style="color: white;">
        <p><strong>Inlagd på intensivvårdsavdelning?: [Ja/Nej]</strong></p>
        <p><strong>Incident Rapport:</strong></p>
        <p><em>· [ Kort sammanfattning av vad som hände och vem som gjorde vad på plats. Notera allt som stack ut om scenen samt vad som gjordes för att behandla patienten ]</em></p>
        <p><strong>Lista över skador:</strong></p>
        <p><em>· [ Ange vilken eller vilka skador som uppstått ]</em></p>
        <p><strong>Kirurgisk rapport:</strong></p>
        <p><em>· [  Fullständig rapport om vad som gjordes under operationen, lista eventuella komplikationer eller något som hittades under operationen. Notera vem som deltog och vad de gjorde under operationen. I slutet av rapporten se till att notera patientens tillstånd efter ]</em></p>
        <p>-----</p>
        <p><strong>Deltar:</strong></p>
        <p><em>· [ Lista alla som deltar här ]</em></p>
        <p><strong>Tillämpade mediciner:</strong></p>
        <p><em>· [ Lista alla som deltar här ]</em></p>
        <p>-----</p>
        <br>
...
`;}
      $(".manage-reports-editing-title").html(
        "Du skapar för närvarande en ny rapport"
      );
            ...
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">Inga fordon som matchar den sökningen</div>
                                    </div>
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Ta bort kan vara aggressiv",
            info: plate,
            status: "",
          },
        ];
          ...
          $(".weapons-items").html(
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">Inga vapen som matchar den sökningen</div>
                                    </div>
                                    <div class="profile-bottom-info">
                                    </div>
                                </div>
                            ...
                            <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                              <div style="display: flex; flex-direction: column;">
                                ...
                                <div class="weapons-bottom-info">
                                  <div class="weapons-id">Serienummer: ${value.serial} · Ägare: ${value.owner} · ID: ${value.id}</div>
                                </div>
                            </div>
                        </div>
                    `;
    ...
    const args = [
      {
        ...
        icon: "fas fa-search",
        text: `Se incidenten #${$(this).data("id")}`,
        info: $(this).data("id"),
        status: "",
      },
    ];
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined)  {
        ...
        $(".cams-nav-item").show();
        $(".map-nav-item").show();
        $(".dispatch-title-ofsomesort").html("Avsändande");
     ...
     /*  let fireCount = 0; */
      ...
      $.each(associateddata, function (index, value) {
        ...
        const associatedIncidentsContainer = (value.associated != 1) && `
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Rekommenderad böter</div>
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Rekommenderad Fängelsetid</div>
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Bötfäll</div>
          ...
          <div class="manage-incidents-title-tag" data-id="${cid}">Häkta</div>
          ...
          <div class="associated-incidents-controls" data-id="${cid}">
            <div id="jail-button" class="control-button" data-id="${cid}"><span class="fa-solid fa-building-columns" style="margin-top: 3.5px;"></span> Fängelse</div>
            <div id="fine-button" class="control-button" data-id="${cid}"><span class="fa-solid fa-file-invoice-dollar" style="margin-top: 3.5px;"></span> Böter</div>
            ${canSendToCommunityService ? `<div id="community-service-button" class="control-button" data-id="${cid}"> <span class="fa-solid fa-person-digging" style="margin-top: 3.5px;"></span>Samhällstjänst</div>` : ''}
          </div>
        `;
        ...
        $(".incidents-ghost-holder").prepend(
          `<div class="associated-incidents-user-container" data-id="${cid}">
              ...
              <div class="associated-incidents-user-tags-holder">
                  <div class="associated-incidents-user-tag ${warrantTag}" data-id="${cid}">Efterlysning</div>
                  <div class="associated-incidents-user-tag ${guiltyTag}" data-id="${cid}">Skyldig</div>
                  <div class="associated-incidents-user-tag ${processedTag}" data-id="${cid}">Bearbetas</div>
                  <div class="associated-incidents-user-tag ${associatedTag}" data-id="${cid}">Associerad</div>
              </div>
              <div class="modify-charges-label"><span class="fas fa-solid fa-info"></span>Högerklicka nedan för att lägga till och/eller ändra brott.</div>
          ...
          `
            <div class="incidents-person-search-item" data-info="${name} (#${value.id})" data-cid="${value.id}" data-name="${name}" data-callsign="${value.callsign}">
                ...
                <div class="incidents-person-search-item-right">
                    ...
                    <div class="incidents-person-search-item-right-name-title">Namn</div>
      ...
      let table = eventData.data;
      $(".manage-bolos-editing-title").html(
        "Du håller på att redigera efterlysning " + table["id"]
      );

      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        $(".manage-bolos-editing-title").html(
          "Du redigerar för närvarande intensivvårdsavdelning Incheckning " + table["id"]
        );
      }
      ...
      let table = eventData.data;
      var reportName = "Allmän efterlysning";
      canSearchForProfiles = true;
      $(".bolos-items").empty();
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
      ...
      $(".manage-bolos-editing-title").html(
        "Du håller på att redigera efterlysning " + id
      );
      ...
      $(".manage-reports-editing-title").html(
        "Du håller på att redigera rapporten " + id
      );
      ...
      $(".manage-reports-editing-title").html(
        "Du håller på att redigera rapporten " + table["id"]
      );
      ...
      const impoundDate = localDate.toLocaleDateString("sv-SE", {
        timeZone: "UTC",
      });
      const impoundTime = localDate.toLocaleTimeString("sv-SE", {
        timeZone: "UTC",
      });
...
function timeShit() {
  ...
  time = localDate.toLocaleTimeString("sv-SE", {
    timeZone: myTimeZone,
  });
  $(".date").html(date);
  $(".time").html(time);
    ...
    $(".profile-items").html(
      `
                      <div class="profile-item" data-id="0">
                          ...
                          <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                          <div style="display: flex; flex-direction: column;">
                              <div class="profile-item-title">Inga användare som matchar den sökningen</div>
                              </div>
                              <div class="profile-bottom-info">
                              </div>
                          </div>
    ...
    <div class="profile-item" data-id="${value.citizenid}" data-fingerprint="${value.fingerprint}">
        ...
        <div style="display: flex; flex-direction: column;">
            ...
            <div class="profile-criminal-tags">
                <span class="license-tag ${warrant}">Efterlysning ${value.warrant ? "JA!" : "Nej"}</span>
                <span class="license-tag ${convictions}">${value.convictions} Brott </span>
            </div>
        </div>
        <div class="profile-bottom-info">
